...
import { a as getBaseURL, i as PACKAGE_VERSION, r as GENERIC_OAUTH_ERROR_CODES } from "./router-CdJRb2NM.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/client-BG5yFBvl.js
...
function LogoMark({ className }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("rect", {
			...
			d: "M9.2 16c0-3.2 2.2-5.2 5.2-5.2 2.4 0 3.8 1.2 4.8 2.6.8 1.1 1.4 1.8 2.6 1.8 1.8 0 3-1.4 3-3.4M22.8 16c0 3.2-2.2 5.2-5.2 5.2-2.4 0-3.8-1.2-4.8-2.6-.8-1.1-1.4-1.8-2.6-1.8-1.8 0-3 1.4-3 3.4",
			fill: "none",
			stroke: "currentColor",
...
//#endregion
export { formatNumber as a, signOut as c, formatCurrency as i, authClient as n, formatPct as o, cn as r, signIn as s, Wordmark as t };
